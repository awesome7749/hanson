...
export default function Receipt() {
  ...
  return <section className="wrap narrow section prose">
    ...
    <div className="panel">
      ...
      {lead.draft.intent === "assessment" && lead.draft.partnerConsent && <p>Your assessment request is coordinated with our sister business Ventrix. The team will confirm the next step and any appointment separately.</p>}
