...
export default function Receipt() {
  ...
  return <section className="wrap narrow section prose">
    ...
    <div className="panel">
      ...
      {lead.draft.partnerConsent && <p>Your request is coordinated with our licensed local service partners. The team will confirm the next step and any appointment separately.</p>}
